...
public class CoinDefinition {
    ...
    public static final String coinName = "Bit";
    public static final String coinTicker = "BIT";
    public static final String coinURIScheme = "bit";
    ...
    public static final String BLOCKEXPLORER_BASE_URL_PROD = "http://explorer.bit.io/";    //blockr.io
    public static final String BLOCKEXPLORER_ADDRESS_PATH = "address/";             //blockr.io path
    public static final String BLOCKEXPLORER_TRANSACTION_PATH = "tx/";              //blockr.io path
    public static final String BLOCKEXPLORER_BLOCK_PATH = "block/";                 //blockr.io path
    public static final String BLOCKEXPLORER_BASE_URL_TEST = BLOCKEXPLORER_BASE_URL_PROD;

    public static final String DONATION_ADDRESS = "Xdeh9YTLNtci5zSL4DDayRSVTLf299n9jv";  //Hash Engineering donation BIT address
    public static final String DONATION_ADDRESS_TESTNET = "";  //Hash Engineering donation BIT address
    ...
    public static final int TARGET_SPACING = (int)(3.5 * 60);  // 3.5 minutes seconds per block.
    ...
    public static final BigInteger MAX_MONEY = BigInteger.valueOf(28000000).multiply(Utils.COIN);                 //main.h:  MAX_MONEY
    ...
    //  Production
    //
    public static final int AddressHeader = 10+10;             //base58.h CBitcoinAddress::PUBKEY_ADDRESS
    ...
    public static final String ID_MAINNET = "org.bit.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.bit.test";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.google.bit.unittest";
